...
public class saveExperimentInfo extends HttpServlet {
	private static final long serialVersionUID = 1L;

	protected static String dbUrl;
	protected static String dbClass;

	public saveExperimentInfo() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request,
		...
		logger.debug(session.getAttribute("expAbbr"));
		logger.debug(session.getAttribute("expId"));
		logger.debug(session.getAttribute("expDisplay"));
