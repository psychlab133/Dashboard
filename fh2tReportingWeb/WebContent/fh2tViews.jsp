...
%>    
    ...
    function loginRequest() {
      ...
      xmlhttp.open("GET", "/MyCasinoWeb/Login.jsp?email=" + txtEmail + "&pwd=" + txtPwd, true);
...
<body>
          ...
          <div id="collapsable-nav" class="collapse navbar-collapse">
            <ul id="nav-list" class="nav navbar-nav navbar-left">
              <li  onclick='getStudents()'>
                <a>
                  <span class=" glyphicon glyphicon-globe" ></span><br class="hidden-xs">Overview</a>
              </li>
              <li>
                <a onclick='getWorlds()'>
              ...
              <li onclick='getAttempts()'>
                <a>
                  <span class="glyphicon glyphicon-record"></span><br class="hidden-xs">Assignments</a>
              </li>
              ...
              <li  onclick='getStudents()'>
                <a>
                  <span class=" glyphicon glyphicon-user" ></span><br class="hidden-xs">Classrooms</a>
              </li>
              <li  onclick='getStudents()'>
                <a>
                  <span class=" glyphicon glyphicon-user" ></span><br class="hidden-xs">Students</a>
              </li>
              <li>
                <a id="loginButton">
                  <span class="glyphicon glyphicon-log-in" id="loginButton"></span><br class="hidden-xs">Sign In</a>
              </li>
            </ul><!-- #nav-list -->
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form>
              ...
              <div class="form-row">
                <button id="loginCancelButton" type="button" class="btn btn-danger btn-sm ml-auto" onclick='toggleLoginModal()'><%= rb.getString("cancel")%></button>
                <button type="button" class="btn btn-primary btn-sm ml-1" onclick='close()'><%= rb.getString("sign_in")%></button>
              </div>
            </form>
          </div>
        </div>
    ...
    <div id="tester" class="container-fluid tester">
    	<div class="jumbotron">
    		<p id="currentQuery" style="color:black;"></p>
      	</div>
		<div id="resultsView" >
		</div>  	
	</div>    
