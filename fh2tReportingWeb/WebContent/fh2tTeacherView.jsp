...
<script>
    ...
    function getReports() {
      ...
      function getReportTables(level,tableList) {
          var xmlhttp;
          alert("getReportTables() level=" + level + " tables=" + tableList);
          ...
          for (; i < len; ) {
        	  	if (tables[i] === "usernames") {
				  	getStudents();
        	  	}
        	  	else if (tables[i] === "problems") {
            	}
	          i++;
          }
...
<script>
	...
	function buildStudentProblemView() {
    ...
    function toggleColumnModal() {
		...
		<script>
			...
			function show_selected() {
				var selector = document.getElementById('reportsSelections');
				rptTables = selector[selector.selectedIndex].value;
			}
		</script>
...
<body>
        ...
        <div class="container">
          <div class="navbar-header">
            <div class="navbar-brand">
              <a href="ResearcherView.jsp">
                <h2><%= rb.getString("teacher")%> <%= rb.getString("dashboard")%></h2>
              </a>
            </div>
          ...
          <div id="collapsable-nav" class="collapse navbar-collapse">
            <ul id="nav-list" class="nav navbar-nav navbar-left">
              <li>
                <a onclick='getReports()'>
                  <span class=" glyphicon fas fa-tasks" ></span><br class="hidden-xs">Reports</a>
              </li>
              <li>
                <a onclick='getWorlds()'>
    ...
    <div class="row">
    	<div id="rptHeader" class="container-fluid tester">
    ...
    <div class="row">
        <div id="tester1" class="container-fluid tester">
		<div class="col-md-8" id="resultsView" >
   		<iframe src="http://localhost:9000/clustervis.php?username=Frank" width = "100%" height = "500" frameborder="1" marginwidth = "10" marginheight = "10" scrolling = "yes">
